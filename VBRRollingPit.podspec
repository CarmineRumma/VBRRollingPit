#
#  Be sure to run `pod spec lint VBRRollingPit.podspec' to ensure this is a
...
![image](https://cdn.dribbble.com/users/1233499/screenshots/4844696/preview.gif)
  ...
  s.author             = { "Viktor Braun (v_b)" => "mail@viktor-braun.de" }
  # Or just: s.author    = "Viktor Braun (v_b)"
  # s.authors            = { "Viktor Braun (v_b)" => "v-braun@live.de" }
  ...
  s.source_files  = "VBRRollingPit/VBRRollingPit/*.swift"
